...
const Header = ({ onMenuToggle, setActiveTab, setSelectedCourseId }) => {
 ...
 const handleSelectCourse = (course) => {
  ...
  return (
    <motion.header
      className="border-b border-blue-100/10 px-2 sm:px-4 py-2 sm:py-3 relative rounded-s-md top-0 z-40 w-full transition-shadow backdrop-blur-lg duration-500"
      animate={controls}
      initial={{
